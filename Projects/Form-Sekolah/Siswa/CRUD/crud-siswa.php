          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                ...
                <td><?= htmlspecialchars($row['student_nis']); ?></td>

                <td><?= htmlspecialchars($row['student_nisn']); ?></td>

                <td>
                  <?= htmlspecialchars($row['student_class'] ?? 'Tidak diketahui'); ?>
                </td>

                <td>
                  <?= htmlspecialchars($row['student_major'] ?? 'Tidak diketahui'); ?>
                </td>
                ...
                <td>
                  ...
                  <div class="d-flex gap-2">
                    ...
                    <a
                      href="edit-siswa.php?id=<?= $row['student_id']; ?>"
